...
def main():
    try:
        ...
        start_end_dict("inputs/submission/test_data.csv")
    ...
    dataloader = torch.utils.data.dataloader(data, batch_size=150, shuffle=False, num_workers=5)
    ...
    for features in dataloader:
        ...
        all_predictions.append(model(features).cpu())
